const apiKey = '0b55760e8b5f79dc1d7342612ba48efa';
const apiUrl = 'https://api.openweathermap.org/data/2.5/weather';

const locationInput = document.querySelector('#searchBar');
const searchButton = document.querySelector('.searchBtn');
const locationElement = document.querySelector('.locName');
const temperatureElement = document.querySelector('.locTemp');
const descriptionElement = document.querySelector('.tempDesc');
...
searchButton.addEventListener('click', () => {
    ...
    if (location) {
        ...
        locationElement.textContent = 'Please enter a valid location';
        iconElement.src = 'img/sorry.png';
    }
});
    ...
    fetch(url)
        ...
        .then(data => {
            ...
            if (temp < 10) {
                ...
                iconElement.src = "img/snow.png";
                descriptionElement.textContent = "The crisp air is invigorating, with temperatures dipping below 10 degrees. It's a perfect day to bundle up and embrace the cooler side of things. Throw on a warm jacket, hat, and gloves, and enjoy the brisk outdoors. Be sure to layer up for warmth, but the crisp air will leave you feeling refreshed and energized.";
                ...
                iconElement.src = "img/very-hot.png";
                ...
                iconElement.src = "img/scorching-sun.png";
                ...
                iconElement.src = "img/blazing.png";
